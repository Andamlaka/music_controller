...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", 'whfxmu35o6%2)9z71og9*efq^7++so1%@i-nwekkj2d8&fi=$t')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get("DEBUG", "False") == "True"

# Use your Render domain in production for tighter security
ALLOWED_HOSTS = ['*']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'frontend', 'templates')],  # Correct template path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
